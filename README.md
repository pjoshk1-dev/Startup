...
- [x] **Stores data in MongoDB** - Stores an array of cards for each user. Unfortunately all I had time for was random colors.
- [x] **Stores credentials in MongoDB** - Stores login credentials.
